<%-- 
    Document   : esrswelcomepage
    Created on : Jul 5, 2015, 11:08:46 AM
    Author     : eneye380
--%>
...
<div class="container" >
    ...
    <div class="row text-center well">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 hero-feature">
            <div class="thumbnail">
                <img src="../img/B0040JHVC2.jpg" alt="" class="img-thumbnail" style="height:200px;width:85%">
                <div class="caption">
                    <h3>Canon E0S 60D</h3>
                    <p>Canon E0S 60D 18MP</p>
                    <p>
                        <!--a href="productview.jsp" class="btn btn-primary">View</a> <a href="#" class="btn btn-default"></a-->
                    <form action="productview.jsp" onsubmit1="checkout()">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 hero-feature">
            <div class="thumbnail">
                <img src="../img/B0035FZJI0.jpg" alt="" class="img-thumbnail" style="height:200px;width:85%">
                <div class="caption">
                    <h3>Canon E0S Rebel</h3>
                    <p>Canon E0S Rebel T2i</p>
                    <p>
                        <!--a href="productview.jsp" class="btn btn-primary">View</a> <a href="#" class="btn btn-default"></a-->
                    <form action="productview.jsp" onsubmit1="return retrievePaR(this)">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 hero-feature">
            <div class="thumbnail">
                <img src="../img/B003ZYF42C.jpg" alt="" class="img-thumbnail" style="height:200px;width:85%">
                <div class="caption">
                    <h3>Nikon D3100</h3>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 hero-feature">
            <div class="thumbnail">
                <img src="../img/B00427Z7N2.jpg" alt="" class="img-thumbnail" style="height:200px;width:85%">
                <div class="caption">
                    <h3>Pentax K-r</h3>
